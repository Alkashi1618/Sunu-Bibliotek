...
<head>
    <meta charset="UTF-8">
    <title>Nouvel Emprunt - Sunu Bibliotek</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        ...
        <div class="info-box">
            <h3>Informations sur les emprunts</h3>
            <ul>
                <li><strong>Durée standard :</strong> 14 jours</li>
                <li><strong>Étudiants :</strong> Maximum 3 emprunts simultanés</li>
                <li><strong>Enseignants :</strong> Maximum 10 emprunts simultanés</li>
                <li><strong>Personnel :</strong> Maximum 5 emprunts simultanés</li>
                <li><strong>Externes :</strong> Maximum 2 emprunts simultanés</li>
                <li><strong>Pénalité de retard :</strong> 100 FCFA par jour</li>
            </ul>
        </div>
        ...
        <form action="${pageContext.request.contextPath}/emprunts" method="post">
            ...
            <div class="form-group">
                    ...
                    <c:forEach items="${documents}" var="doc">
                        ...
                        %>
                            <option value="<%= doc.getNumEnreg() %>">
                                ...
                                (<%= docType %>) - Dispo: <%= doc.getQuantiteDisponible() %>
                            </option>
                        <%
                            }
                        %>
                ...
                <div class="help-text">Seuls les documents disponibles sont affichés</div>
            </div>
